...
parser = argparse.ArgumentParser(description='Open gene list infile, skip the header and search Kannapedia database for variants in genes in infile.')
...
def main():
    my_db = connect_to_db()
    gene_infile_list = infile_list()
    sql_query(my_db, gene_infile_list)
